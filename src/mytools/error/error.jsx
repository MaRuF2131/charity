...
export default () => {
        useEffect(() => {
          document.title ="Error - Charity"; // your dynamic title
        }, []);
    return (
        <main>
            <div className="max-w-screen-xl dark:bg-gray-500 mx-auto px-4 flex items-center justify-start h-screen md:px-8">
