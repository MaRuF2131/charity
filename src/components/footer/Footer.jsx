export default () => {
    ...
    return (
        <footer className="text-gray-500 bg-white dark:text-black dark:bg-gray-500 px-4 py-5 max-w-screen-xl mx-auto md:px-8">
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2025 Inovation IT All rights reserved.
                </div>
